  ...
  const clearCache = async () => {
    try {
      ...
      if (data.success) {
        toast({
          title: "Success",
          description: "Cache cleared successfully. Refresh the page to see changes.",
        })
      } else {
    ...
    <div className="container py-8">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Use this form to directly update image URLs for a project in the database</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-4 flex gap-4">
              ...
              <Button type="button" variant="outline" onClick={clearCache} disabled={isLoading}>
        ...
        {result && (
          <CardFooter className="flex-col items-start">
            ...
            <pre className="bg-muted p-4 rounded w-full overflow-auto">{JSON.stringify(result, null, 2)}</pre>
          </CardFooter>
        )}
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          <div>
            <a href="/projects" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
              View Projects Page
            </a>
          </div>
          <div>
