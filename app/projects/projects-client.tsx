...
import { ArrowRight, Calendar, Clock, Star, Filter, Search, X, Check } from "lucide-react"
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          >
            ...
            Filters
            {(selectedCategory || selectedStatus || sortOption !== "newest") && (
              <span className="ml-2 bg-blue-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                {[selectedCategory, selectedStatus, sortOption !== "newest" ? 1 : null].filter(Boolean).length}
              </span>
            )}
          </button>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <Check className={`h-4 w-4 mr-2 ${selectedCategory === null ? "opacity-100" : "opacity-0"}`} />
                        All Categories
                      </button>
                      {categories.map((category) => (
                        ...
                        >
                          <Check
                            className={`h-4 w-4 mr-2 ${selectedCategory === category ? "opacity-100" : "opacity-0"}`}
                          />
                          {category}
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <Check className={`h-4 w-4 mr-2 ${selectedStatus === null ? "opacity-100" : "opacity-0"}`} />
                        All Statuses
                      </button>
                      {statuses.map((status) => (
                        <button
                        ...
                        >
                          <Check
                            className={`h-4 w-4 mr-2 ${selectedStatus === status ? "opacity-100" : "opacity-0"}`}
                          />
                          {status}
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <Check className={`h-4 w-4 mr-2 ${sortOption === "newest" ? "opacity-100" : "opacity-0"}`} />
                        Newest First
                      </button>
                      <button
                      ...
                      >
                        <Check className={`h-4 w-4 mr-2 ${sortOption === "oldest" ? "opacity-100" : "opacity-0"}`} />
                        Oldest First
                      </button>
                      <button
                      ...
                      >
                        <Check className={`h-4 w-4 mr-2 ${sortOption === "a-z" ? "opacity-100" : "opacity-0"}`} />
                        A-Z
                      </button>
                      <button
                      ...
                      >
                        <Check className={`h-4 w-4 mr-2 ${sortOption === "z-a" ? "opacity-100" : "opacity-0"}`} />
                        Z-A
                      </button>
                      <button
                      ...
                      >
                        <Check
                          className={`h-4 w-4 mr-2 ${sortOption === "completion-high" ? "opacity-100" : "opacity-0"}`}
                        />
                      ...
                      >
                        <Check
                          className={`h-4 w-4 mr-2 ${sortOption === "completion-low" ? "opacity-100" : "opacity-0"}`}
                        />
                      ...
                      >
                        <Check
                          className={`h-4 w-4 mr-2 ${sortOption === "priority-high" ? "opacity-100" : "opacity-0"}`}
                        />
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4">
            ...
            {selectedCategory && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-900/50 text-blue-400 border border-blue-800">
                ...
                <button onClick={() => setSelectedCategory(null)} className="ml-1 text-blue-400 hover:text-blue-300">
                  <X className="h-3 w-3" />
                </button>
              </span>
            )}
            {selectedStatus && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-900/50 text-blue-400 border border-blue-800">
                ...
                <button onClick={() => setSelectedStatus(null)} className="ml-1 text-blue-400 hover:text-blue-300">
                  <X className="h-3 w-3" />
                </button>
              </span>
            )}
            {searchQuery && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-900/50 text-blue-400 border border-blue-800">
                Search: {searchQuery}
                <button onClick={() => setSearchQuery("")} className="ml-1 text-blue-400 hover:text-blue-300">
                  <X className="h-3 w-3" />
                </button>
              </span>
            )}
            <button onClick={resetFilters} className="text-xs text-blue-400 hover:text-blue-300 ml-2">
              Clear All
            </button>
          </div>
        )}
            ...
            filteredProjects.map((project) => (
              ...
              >
                <div className="relative h-48 w-full overflow-hidden">
                  ...
                  {/* Project image */}
                  <Image
                    src={project.image_url || "/placeholder.svg?height=400&width=600&query=tech project visualization"}
                    alt={project.title}
                    fill
