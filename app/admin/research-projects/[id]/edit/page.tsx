...
export default async function EditResearchProjectPage({
  ...
  async function updateResearchProject(formData: FormData) {
    "use server"
    ...
    // Delete existing challenges and insert new ones
  ...
  return (
    <div className="container py-10">
      ...
      <ResearchProjectForm project={processedProject} action={updateResearchProject} />
    </div>
  )
}
